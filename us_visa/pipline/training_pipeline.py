...
class TrainPipeline:
    ...
    def start_data_ingestion(self) -> DataIngestionArtifact:
        """
        This method of TrainPipeline class is responsible for starting the data ingestion process.
        """
        try:
    ...
    def run_pipeline(self) -> None:
        """
        this method of train pipeline class is responsible for running the entire training pipeline.
        """
        try:
